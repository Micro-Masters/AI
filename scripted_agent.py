...
class MoveToBeacon(base_agent.BaseAgent):
  ...
  def step(self, obs):
    ...
    print("score_cumulative " + str(obs.observation['score_cumulative']))
    print("available_actions " + str(obs.observation['available_actions']))
    print("single_select " + str(obs.observation['single_select']))
    print("multi_select " + str(obs.observation['multi_select']))
